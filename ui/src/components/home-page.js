...
let HomePage = class HomePage extends LitElement {
    ...
    async ensureAuctionDetail(id) {
        const idx = this.auctions.findIndex((a) => a.id === id);
        if (idx === -1)
            return;
        if (this.auctions[idx].teams)
    ...
    renderAuctionCard(a) {
        ...
        const cardCls = "rounded-lg border bg-white p-3 shadow-sm cursor-pointer transition " +
            (isSelected
      ...
      <div class=${cardCls} @click=${() => this.selectAuction(a.id)}>
        ...
        <div class="flex gap-3 mt-2 text-xs" @click=${(e) => e.stopPropagation()}>
          ${canEdit
            ? html `<button
...
__decorate([
    state()
], HomePage.prototype, "auctions", void 0);
__decorate([
    state()
], HomePage.prototype, "selectedAuctionId", void 0);
__decorate([
    state()
], HomePage.prototype, "loading", void 0);
__decorate([
    state()
], HomePage.prototype, "loadError", void 0);
__decorate([
    state()
], HomePage.prototype, "dialogOpen", void 0);
__decorate([
    state()
], HomePage.prototype, "dialogMode", void 0);
__decorate([
    state()
], HomePage.prototype, "dialogAuction", void 0);
HomePage = __decorate([
